...
const HostRoom = ({ uid, roomid }) => {
    ...
    if (screenTrack) {
        tracksToPublish.push(screenTrack);
    }
    ...
    return (
        <>
            <div className={`w-screen bg-red-500 h-[88%] px-2 gap-2 flex flex-col`}>
