            ...
            <div className="h-[84%] font-helvetica flex flex-col gap-4 text-white px-16 pt-7 pb-3">
                <div className='h-[10%] flex gap-8 items-center col-span-2'>
                    <div className='w-1/2 flex gap-4 items-center'>
                        ...
                        <div className='ms-auto text-lg text-primary font-bold tracking-widest'>{timeLeft.hours}<span className='text-base'>hr</span> {timeLeft.minutes}<span className='text-base'>min</span> {timeLeft.seconds}<span className='text-base'>sec</span></div>
                    </div>
