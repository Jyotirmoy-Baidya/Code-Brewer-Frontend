            ...
            <div className="h-[84%] font-helvetica flex flex-col gap-4 text-white px-16 pt-4 pb-3">
                <div className='h-[10%] flex gap-8 items-center col-span-2'>
                    ...
                    <div className='w-1/2 flex items-center justify-between'>
                        ...
                        <div className='bg-blue-600 h-10 w-24 flex justify-center items-center rounded-md active:bg-blue-800' onClick={() => runCode()}>{runCodeLoading ? <AiOutlineLoading3Quarters className='text-lg loading-spin' /> : "Run Code"}</div>
                    </div>
                </div>
                <div className='h-[90%] flex gap-8'>
                    ...
                    <CodingPlayground code={code} setCode={setCode} language={language} setLanguage={setLanguage} input={input} setInput={setInput} output={output} setOutput={setOutput} metrics={metrics} setMetrics={setMetrics} runCode={runCode} handleLanguageChange={handleLanguageChange} getLanguageExtension={getLanguageExtension} />
                </div>
            </div>
        </>
    )
